...
// Start Class
if ( ! class_exists( 'UWL_Image_Resize' ) ) {

	class UWL_Image_Resize {
		...
		public function __construct() {
			$this->retina_enabled = apply_filters( 'uwl_image_resize_retina', 'retina' );
		}
		...
		public function process( $args ) {
			...
			if ( $crop && get_theme_mod( 'image_resizing', true ) ) {
				if ( is_array( $crop ) ) {
...
// Helper function for resizing images using the UWL_Image_Resize class
if ( ! function_exists( 'uwl_image_resize' ) ) {
	function uwl_image_resize( $args ) {
		$class = new UWL_Image_Resize;
